async function exportBattlePlanToPDF() {
  ...
  tasks.forEach((task, i) => {
    ...
    if (i % 2 === 0) {
      ...
      doc.rect(10, y - 4, 190, blockHeight, "F");
    }

    // Position checkbox relative to first line of text
    const checkboxY = y - 3;
    
    doc.setDrawColor(41, 128, 185);
    doc.rect(14, checkboxY, 4, 4);
    if (checked) {
      doc.setDrawColor(39, 174, 96);
      doc.setLineWidth(0.6);
      doc.line(14, checkboxY, 18, checkboxY + 4);
      doc.line(18, checkboxY, 14, checkboxY + 4);
    }
  ...
  doc.setTextColor(255, 255, 255);
  doc.setFontSize(8);
  doc.text("Generated by Knowledge | Your Scientology Toolbox Program.", 105, 293, { align: "center" });
